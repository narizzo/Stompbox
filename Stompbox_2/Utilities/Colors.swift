...
let systemLightGray = UIColor(red: 160/255, green: 160/255, blue: 160/255, alpha: 1.0)
let darkerGray = UIColor(red: 20/255, green: 20/255, blue: 25/255, alpha: 1.0)

let foregroundColor = blue

let trackLayerHighlight = UIColor.white.cgColor
let trackLayerDefault = blue.cgColor

let clockLayerHighlight = trackLayerHighlight
let clockLayerDefault = trackLayerDefault

let knobText = systemLightGray
